...
class NG125Seeder extends Seeder
{
    public function run()
    {
        ...
        // Массив всех моделей NG125
        $models = [
            // NG125N — автоматические выключатели (B/C/D кривые, 10–125A, 1-4P)
            ['NG125N 1P B10', 1, 10, 'B'],
            ['NG125N 1P B16', 1, 16, 'B'],
            ['NG125N 1P B20', 1, 20, 'B'],
            ['NG125N 1P B25', 1, 25, 'B'],
            ...
            ['NG125N 2P B20', 2, 20, 'B'],
            ['NG125N 2P B25', 2, 25, 'B'],
            ['NG125N 2P B32', 2, 32, 'B'],
            ['NG125N 2P B40', 2, 40, 'B'],
            ['NG125N 2P B50', 2, 50, 'B'],
            ['NG125N 2P B63', 2, 63, 'B'],
            ['NG125N 2P B80', 2, 80, 'B'],
            ['NG125N 2P B100', 2, 100, 'B'],
            ['NG125N 2P B125', 2, 125, 'B'],

            ['NG125N 3P B10', 3, 10, 'B'],
            ['NG125N 3P B16', 3, 16, 'B'],
            ['NG125N 3P B20', 3, 20, 'B'],
            ['NG125N 3P B25', 3, 25, 'B'],
            ['NG125N 3P B32', 3, 32, 'B'],
            ['NG125N 3P B40', 3, 40, 'B'],
            ['NG125N 3P B50', 3, 50, 'B'],
            ['NG125N 3P B63', 3, 63, 'B'],
            ['NG125N 3P B80', 3, 80, 'B'],
            ['NG125N 3P B100', 3, 100, 'B'],
            ['NG125N 3P B125', 3, 125, 'B'],

            ['NG125N 4P B10', 4, 10, 'B'],
            ['NG125N 4P B16', 4, 16, 'B'],
            ['NG125N 4P B20', 4, 20, 'B'],
            ['NG125N 4P B25', 4, 25, 'B'],
            ['NG125N 4P B32', 4, 32, 'B'],
            ['NG125N 4P B40', 4, 40, 'B'],
            ['NG125N 4P B50', 4, 50, 'B'],
            ['NG125N 4P B63', 4, 63, 'B'],
            ['NG125N 4P B80', 4, 80, 'B'],
            ['NG125N 4P B100', 4, 100, 'B'],
            ['NG125N 4P B125', 4, 125, 'B'],


            ['NG125N 1P C10', 1, 10, 'C'],
            ['NG125N 1P C16', 1, 16, 'C'],
            ['NG125N 1P C20', 1, 20, 'C'],
            ['NG125N 1P C25', 1, 25, 'C'],
            ['NG125N 1P C32', 1, 32, 'C'],
            ['NG125N 1P C40', 1, 40, 'C'],
            ...
            ['NG125N 2P C20', 2, 20, 'C'],
            ['NG125N 2P C25', 2, 25, 'C'],
            ['NG125N 2P C32', 2, 32, 'C'],
            ['NG125N 2P C40', 2, 40, 'C'],
            ['NG125N 2P C50', 2, 50, 'C'],
            ['NG125N 2P C63', 2, 63, 'C'],
            ['NG125N 2P C80', 2, 80, 'C'],
            ['NG125N 2P C100', 2, 100, 'C'],
            ['NG125N 2P C125', 2, 125, 'C'],

            ['NG125N 3P C10', 3, 10, 'C'],
            ['NG125N 3P C16', 3, 16, 'C'],
            ['NG125N 3P C20', 3, 20, 'C'],
            ['NG125N 3P C25', 3, 25, 'C'],
            ['NG125N 3P C32', 3, 32, 'C'],
            ['NG125N 3P C40', 3, 40, 'C'],
            ['NG125N 3P C50', 3, 50, 'C'],
            ['NG125N 3P C63', 3, 63, 'C'],
            ['NG125N 3P C80', 3, 80, 'C'],
            ['NG125N 3P C100', 3, 100, 'C'],
            ['NG125N 3P C125', 3, 125, 'C'],

            ['NG125N 4P C10', 4, 10, 'C'],
            ['NG125N 4P C16', 4, 16, 'C'],
            ['NG125N 4P C20', 4, 20, 'C'],
            ['NG125N 4P C25', 4, 25, 'C'],
            ['NG125N 4P C32', 4, 32, 'C'],
            ['NG125N 4P C40', 4, 40, 'C'],
            ['NG125N 4P C50', 4, 50, 'C'],
            ['NG125N 4P C63', 4, 63, 'C'],
            ['NG125N 4P C80', 4, 80, 'C'],
            ['NG125N 4P C100', 4, 100, 'C'],
            ['NG125N 4P C125', 4, 125, 'C'],


            ['NG125N 1P D10', 1, 10, 'D'],
            ['NG125N 1P D16', 1, 16, 'D'],
            ['NG125N 1P D20', 1, 20, 'D'],
            ['NG125N 1P D25', 1, 25, 'D'],
            ['NG125N 1P D32', 1, 32, 'D'],
            ['NG125N 1P D40', 1, 40, 'D'],
            ...
            ['NG125N 2P D20', 2, 20, 'D'],
            ['NG125N 2P D25', 2, 25, 'D'],
            ['NG125N 2P D32', 2, 32, 'D'],
            ['NG125N 2P D40', 2, 40, 'D'],
            ['NG125N 2P D50', 2, 50, 'D'],
            ['NG125N 2P D63', 2, 63, 'D'],
            ['NG125N 2P D80', 2, 80, 'D'],
            ['NG125N 2P D100', 2, 100, 'D'],
            ['NG125N 2P D125', 2, 125, 'D'],


            ['NG125N 3P D10', 3, 10, 'D'],
            ['NG125N 3P D16', 3, 16, 'D'],
            ['NG125N 3P D20', 3, 20, 'D'],
            ['NG125N 3P D25', 3, 25, 'D'],
            ['NG125N 3P D32', 3, 32, 'D'],
            ['NG125N 3P D40', 3, 40, 'D'],
            ['NG125N 3P D50', 3, 50, 'D'],
            ['NG125N 3P D63', 3, 63, 'D'],
            ['NG125N 3P D80', 3, 80, 'D'],
            ['NG125N 3P D100', 3, 100, 'D'],
            ['NG125N 3P D125', 3, 125, 'D'],


            ['NG125N 4P D10', 4, 10, 'D'],
            ['NG125N 4P D16', 4, 16, 'D'],
            ['NG125N 4P D20', 4, 20, 'D'],
            ['NG125N 4P D25', 4, 25, 'D'],
            ['NG125N 4P D32', 4, 32, 'D'],
            ['NG125N 4P D40', 4, 40, 'D'],
            ['NG125N 4P D50', 4, 50, 'D'],
            ['NG125N 4P D63', 4, 63, 'D'],
            ['NG125N 4P D80', 4, 80, 'D'],
            ['NG125N 4P D100', 4, 100, 'D'],
            ['NG125N 4P D125', 4, 125, 'D'],


            // NG125H — автоматические выключатели (C кривая, 10–80A, 1–4P)
            ...
            // NG125L — автоматические выключатели (B/C/D кривые, 10–80A, 1–4P)
            ...
            ['NG125L 4P D63', 5, 63, 'D'],
            ['NG125L 4P D80', 4, 80, 'D'],


            // NG125LMA — защита двигателей (кривая MA, 4–80A, 2–3P)
