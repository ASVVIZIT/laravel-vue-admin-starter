...
class SpecialSeriesSeeder extends Seeder
{
        ...
        foreach ($models as $model) {
            ...
            CircuitBreaker::updateOrCreate(
                ...
                [
                    ...
                    'voltage' => Str::contains($modelName, 'NG125LMA') ? '250' : '440',
                    'voltage_unit_id' => $units['v'],
                    'energy_class' => Str::contains($modelName, 'NG125LMA') ? 'A-III' : 'A-IV',
                    'ip_rating' => 'IP54',
                    ...
                    'combined_protection' => Str::contains($modelName, 'NG125LMA') ? 'Двигатели (MA кривая)' : null,
                ]
            );
        }
    }
    ...
    {
        return match (true) {
            Str::contains($modelName, 'NG125LMA') => 'Acti9 NG125',
            Str::contains($modelName, 'C120H') => 'Acti9 C120',
            Str::contains($modelName, 'iK60N') => 'Acti9 iK60',
    ...
    {
        return match (true) {
            Str::contains($modelName, 'NG125LMA') => 4.0, // Icu=4kA
            Str::contains($modelName, 'C120H') => 25.0,  // Icu=25kA
    ...
    {
        return match (true) {
            Str::contains($modelName, 'NG125LMA') => 'IEC 60947-2',
            Str::contains($modelName, 'iK60N') => 'IEC 60898-1',
            default => 'IEC 60947-2',
        };
    }
}
