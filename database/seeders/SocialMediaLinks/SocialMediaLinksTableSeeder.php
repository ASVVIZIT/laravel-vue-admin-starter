    ...
    public function run()
    {
        ...
        $links = [
            ...
            [
                ...
                'icon' => 'fab fa-google-maps',
                'description' => 'Наше местоположение на Google Maps',
                'order_column' => 1,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'icon' => 'fab fa-yandex-maps',
                'description' => 'Наше местоположение на Яндекс Картах',
                'order_column' => 2,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                ...
                'icon' => 'fab fa-twitter',
                'description' => 'Наша страница в Twitter',
                'order_column' => 8,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                ...
                'url' => '#',
                'icon' => 'default',
                'description' => 'Запись по умолчанию',
                'order_column' => 13,
                'created_at' => now(),
                'updated_at' => now(),
            ],
