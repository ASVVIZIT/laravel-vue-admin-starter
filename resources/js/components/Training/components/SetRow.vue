<template>
  <div class="set-row">
    ...
    <!-- Поле дистанции -->
    <el-input-number
        v-if="isFieldVisible('distance')"
        v-model="localSet.distance"
        :min="0" :max="42195" :step="0.1"
    ...
    <el-input
        ...
        placeholder="Заметки" size="small"
...
// Инициализируем композабл для управления видимостью полей
