...
const props = defineProps({
  ...
  batteryTypeId: { type: String, default: 'li-fe-po4-32650' },
  height: { type: String, default: '58px' },
...
const colors = computed(() => config.value?.visualConfig?.colors ?? { normal: '#4caf50', warning: '#ff9800', critical: '#f44336', off: '#9e9e9e' })
...
const chemistry = computed(() => config.value?.specs?.chemistry?.toUpperCase() ?? 'LFP')
