...
const props = defineProps({
  ...
  batteryTypeId: { type: String, default: 'li-ion-14650' },
...
const shortName = computed(() => config.value?.shortName ?? '14650')
const capacity = computed(() => config.value?.specs?.capacity ?? 800)
