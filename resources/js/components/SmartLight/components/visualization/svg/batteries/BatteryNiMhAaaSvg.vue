...
const props = defineProps({
  ...
  batteryTypeId: { type: String, default: 'nimh-aaa' },
...
const shortName = computed(() => config.value?.shortName ?? 'NiMH AAA')
const capacity = computed(() => config.value?.specs?.capacity ?? 1100)
