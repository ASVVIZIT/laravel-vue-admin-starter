...
export const BATTERY_TYPES = {
    'li-ion-18650': {
        ...
        dimensions: { diameter: 18, height: 65, unit: 'mm' },
        shape: 'cylinder',
        chargeCycles: 500,
        weight: 45,
        energyDensity: 250,
        temperatureRange: { min: -20, max: 60, unit: '°C' },
        safetyFeatures: ['protection_circuit', 'thermal_shutdown', 'pressure_relief_valve'],
        visualFeatures: {
            fluidEffect: true,
            liquidColor: '#67c23a',
        ...
        groupVisualization: {
            series: { spacing: 10, connectionStyle: 'curved' },
            parallel: { spacing: 5, connectionStyle: 'straight' }
        },
        defaultSettings: {
            voltage: 3.7,
    ...
    'li-ion-21700': {
        ...
        dimensions: { diameter: 21, height: 70, unit: 'mm' },
        shape: 'cylinder',
        chargeCycles: 600,
        weight: 60,
        energyDensity: 270,
        ...
        groupVisualization: {
            series: { spacing: 12, connectionStyle: 'curved' },
            parallel: { spacing: 7, connectionStyle: 'straight' }
        },
        defaultSettings: {
            voltage: 3.7,
            critical_voltage: 3.0,
    ...
    'li-po': {
        ...
        dimensions: { width: 50, height: 35, depth: 5, unit: 'mm' },
        shape: 'rectangle',
        chargeCycles: 300,
        weight: 30,
        energyDensity: 200,
        temperatureRange: { min: -20, max: 60, unit: '°C' },
        safetyFeatures: ['protection_circuit', 'thermal_shutdown'],
        visualFeatures: {
            fluidEffect: true,
            liquidColor: '#409eff',
            criticalColor: '#f56c6c',
        ...
        groupVisualization: {
            series: { spacing: 8, connectionStyle: 'straight' },
            parallel: { spacing: 4, connectionStyle: 'straight' }
        },
        defaultSettings: {
            voltage: 3.7,
    ...
    'lead-acid': {
        ...
        dimensions: { width: 90, height: 170, depth: 50, unit: 'mm' },
        shape: 'rectangle',
        chargeCycles: 300,
        weight: 1500,
        energyDensity: 40,
        temperatureRange: { min: -20, max: 50, unit: '°C' },
        safetyFeatures: ['ventilation', 'acid_leak_protection'],
        visualFeatures: {
            fluidEffect: true,
            liquidColor: '#67c23a',
            criticalColor: '#f56c6c',
        ...
        groupVisualization: {
            series: { spacing: 15, connectionStyle: 'straight' },
            parallel: { spacing: 10, connectionStyle: 'straight' }
        },
        defaultSettings: {
            voltage: 12.0,
