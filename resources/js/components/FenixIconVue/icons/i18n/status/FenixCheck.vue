<!-- resources/js/components/FenixIconVue/icons/i18n/status/FenixCheck.vue -->
<template>
  <svg
      version="1.1"
  ...
  >
    <defs>
      <linearGradient v-if="props.useGradients" id="checkGradient" x1="0%" y1="0%" x2="100%" y2="100%">
    ...
    <circle
        ...
        r="10"
        fill="none"
        :stroke="props.useGradients ? 'url(#checkGradient)' : props.color"
        stroke-width="1.5"
    />
