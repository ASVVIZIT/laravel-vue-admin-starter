<template>
  ...
  >
    <defs>
      <linearGradient v-if="props.useGradients" id="settingsGradient" x1="0%" y1="0%" x2="100%" y2="100%">
    ...
    <path
        ...
        fill="none"
        :stroke="props.useGradients ? 'url(#settingsGradient)' : props.color"
        stroke-width="0.5"
...
<script>
export default { name: 'FenixSettings', inheritAttrs: false }
</script>
