export default {
    ...
    "i18nChecker": {
        ...
        "settings": {
            ...
            "behavior": {
                ...
                "cacheUsed": "Из кэша",
                "cacheFresh": "Актуальные данные",
                "cacheExpired": "Кэш устарел",
                "uiTitle": "Интерфейс",
    ...
    "diagnostics": {
        ...
        "system_users": {
            ...
            "banned": "Забанен",
            "trashed": "Удалён",
            "create": "Создать системного",
            "form_create_title": "Создание системного пользователя",
            "form_edit_title": "Редактирование системного пользователя",
            "placeholder_name": "Например: Test Manager",
            "placeholder_email": "test_manager@fenix.dev",
            "placeholder_role": "Выберите роль",
            "placeholder_password": "Минимум 6 символов",
            "placeholder_password_edit": "Оставьте пустым, чтобы не менять",
            "placeholder_password_confirm": "Повторите пароль",
            "password": "Пароль",
            "password_edit_label": "Новый пароль",
            "password_edit_hint": "Оставьте поле пустым, если не хотите менять пароль",
            ...
            "required_role": "Выберите роль",
            "required_password": "Введите пароль",
            "confirm_delete": "Удалить пользователя «{name}»? Его можно будет восстановить.",
            "confirm_delete_title": "Удаление пользователя",
            "confirm_restore": "Восстановить пользователя «{name}»?",
            "confirm_restore_title": "Восстановление",
            "confirm_reset": "Удалить все системные пользователи и создать их заново?",
            "confirm_reset_title": "Сброс системных пользователей",
            "message_create_success": "Системный пользователь создан",
            "message_update_success": "Изменения сохранены",
            "message_delete_success": "Пользователь удалён — можно восстановить",
            "message_restore_success": "Пользователь восстановлен",
            "message_reset_success": "Системные пользователи сброшены и пересозданы",
            "tooltip_edit_trashed": "Пользователь удалён — сначала восстановите, затем редактируйте",
            "tooltip_delete_trashed": "Пользователь уже удалён — используйте «Восстановить»",
            "tooltip_restore_alive": "Пользователь активен — восстанавливать нечего"
        },
        "help": {
        ...
        "fix": {
            ...
            "copy_list_action": "Скопировать",
            "copy_list_object": "список полей",
