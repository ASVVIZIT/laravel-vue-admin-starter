export default {
  ...
  "diagnostics": {
    ...
    "system_users": {
      ...
      "form_create_title": "Create System User",
      "form_edit_title": "Edit System User",
      "placeholder_name": "e.g. Test Manager",
      "placeholder_email": "test_manager@fenix.dev",
      "placeholder_role": "Select role",
      "placeholder_password": "At least 6 characters",
      "placeholder_password_edit": "Leave empty to keep current",
      "placeholder_password_confirm": "Repeat password",
      "password": "Password",
      "password_edit_label": "New password",
      "password_edit_hint": "Leave empty to keep the current password",
      ...
      "confirm_delete": "Delete user «{name}»? It can be restored later.",
      "confirm_delete_title": "Delete User",
      "confirm_restore": "Restore user «{name}»?",
      "confirm_restore_title": "Restore User",
      "confirm_reset": "Delete all system users and recreate them?",
      "confirm_reset_title": "Reset System Users",
      "message_create_success": "System user created",
      "message_update_success": "Changes saved",
      "message_delete_success": "User deleted — can be restored",
      "message_restore_success": "User restored",
    ...
    "fix": {
      ...
      "copy_list": "Copy list",
      "copy_list_action": "Copy",
      "copy_list_object": "field list",
