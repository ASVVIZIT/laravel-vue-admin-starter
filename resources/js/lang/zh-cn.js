export default {
  ...
  "diagnostics": {
    ...
    "system_users": {
      ...
      "trashed": "已删除",
      "create": "创建系统用户",
      "form_create_title": "创建系统用户",
      "form_edit_title": "编辑系统用户",
      "placeholder_name": "例如：Test Manager",
      "placeholder_email": "test_manager@fenix.dev",
      "placeholder_role": "选择角色",
      "placeholder_password": "至少 6 个字符",
      "placeholder_password_edit": "留空保持不变",
      "placeholder_password_confirm": "重复密码",
      "password": "密码",
      "password_edit_label": "新密码",
      "password_edit_hint": "留空以保持当前密码",
      "password_confirm": "确认密码",
      "password_mismatch": "密码不匹配",
      "password_min": "至少 6 个字符",
      "required_name": "名称必填",
      "required_email": "邮箱必填",
      "invalid_email": "邮箱无效",
      "required_role": "角色必填",
      "required_password": "密码必填",
      "confirm_delete": "删除用户 «{name}»？之后可以恢复。",
      "confirm_delete_title": "删除用户",
      "confirm_restore": "恢复用户 «{name}»？",
      "confirm_restore_title": "恢复用户",
      "confirm_reset": "删除所有系统用户并重新创建？",
      "confirm_reset_title": "重置系统用户",
      "message_create_success": "系统用户已创建",
      "message_update_success": "更改已保存",
      "message_delete_success": "用户已删除 — 可以恢复",
      "message_restore_success": "用户已恢复",
